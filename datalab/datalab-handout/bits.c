...
int isAsciiDigit(int x) {
    int first_stu = (0x03 ^ (x >> 4)); // 0 point to ok
    int second_stu = (x >> 3 & 1) & ((x >> 1 & 1) | (x >> 2 & 1));  // 0 point to ok
    return (!first_stu) & (!second_stu);
}
/* 
